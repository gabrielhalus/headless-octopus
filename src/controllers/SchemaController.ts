    ...
    try {
      ...
      const newSchemaWithLinks = {
        ...
        links: [
          ...
          { rel: "delete", href: `/schemas/${newSchema._id}`, method: "DELETE" },
        ]
      }
    ...
    try {
      ...
      const updatedSchemaWithLinks = {
        ...
        links: [
          ...
          { rel: "update", href: `/schemas/${updatedSchema._id}`, method: "PUT" },
          { rel: "delete", href: `/schemas/${updatedSchema._id}`, method: "DELETE" },
        ]
      }
